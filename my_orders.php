        ...
        <?php if (mysqli_num_rows($orders) > 0): ?>
            <table class="min-w-full divide-y divide-gray-200 table-auto text-center">
                <thead class="bg-orange-600 text-white rounded-t-xl">
                    <tr>
                        <th scope="col" class="w-10 px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider rounded-tl-xl">No</th>
                        <th scope="col" class="w-28 px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Tanggal</th>
                        <th scope="col" class="w-48 px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Alamat</th>
                        <th scope="col" class="w-40 px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Metode Pembayaran</th>
                        <th scope="col" class="w-28 px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Status</th>
                        <th scope="col" class="w-48 px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Deskripsi Pengiriman</th>
                        <th scope="col" class="w-20 px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider">Rating</th>
                        <th scope="col" class="w-20 px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider rounded-tr-xl">Aksi</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-yellow-50 transition-colors duration-200">
                        <td class="px-6 py-4 whitespace-normal text-sm font-medium text-gray-900"><?php echo $no++; ?></td>
                        <td class="px-6 py-4 whitespace-normal text-sm text-gray-700"><?php echo htmlspecialchars($row['order_date']); ?></td>
                        ...
                        <td class="px-6 py-4 whitespace-normal text-sm font-semibold text-orange-600 cursor-pointer hover:underline">
